...
namespace CommandPattern
{
    public class CommandInterpreter : ICommandInterpreter
    {
        ...
        {
            string[] commandInputArguments = args.Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries).ToArray();
            ...
            Type type = assembly.GetTypes().FirstOrDefault(t => t.Name.ToLower() == commandName.ToLower());
